/**
  ******************************************************************************
  * @file    Libraries/Device/Phoenix/txf5200_assert.h
  * @author  HUGE-IC Application Team
  * @version V1.0.0
  * @date    01-08-2018
  * @brief   CMSIS Cortex-M3 Device Peripheral Access Layer System Source File.
  *          This file contains the system clock configuration for TXF5200 devices,
...
#ifndef __TXF5200_ASSERT_H
#define __TXF5200_ASSERT_H

#ifdef __cplusplus
 extern "C" {
#endif
    
/** @addtogroup TXF5200_ASSERT TXF5200 System
  * @{
  */
     
/** @addtogroup assert_interface_gr Assert 
  * @ingroup  TXF5200_ASSERT
  * @{
  */ 
