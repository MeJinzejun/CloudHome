/**
  ******************************************************************************
  * @file    Libraries/Device/Phoenix/include/txf5200.h
  * @author  HUGE-IC Application Team
  * @version V1.0.1
  * @date    22-04-2019
  * @brief   CMSIS Cortex-M3 Device Peripheral Access Layer Header File.
  *          This file contains all the peripheral register's definitions, bits
  *          definitions and memory mapping for TXF5200 Connectivity line.
...
/**
 * @brief TXF5200 Interrupt Number Definition, according to the selected device
 */
typedef enum IRQn {
