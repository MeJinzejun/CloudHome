/**
  ******************************************************************************
  * @file    Libraries/Driver/include/LL/tx_phe_ll_iic.h
...
#ifndef __TX_PHE_LL_IIC_H
#define __TX_PHE_LL_IIC_H
 ...
 */
#define LL_IIC_TAR_SMBUS_QUICK_CMD                          (1UL << 16)
 ...
 */
#define LL_IIC_HS_MADDR_IC_HS_MAR(n)                        (((n)&0x7) << 0)
 ...
 *  speed
 */
#define LL_IIC_IC_SS_SCL_HCNT(n)                            (((n)&0xFFFF) << 0)
 ...
 *  speed
 */
#define LL_IIC_IC_SS_SCL_LCNT(n)                            (((n)&0xFFFF) << 0)
 ...
 *  fast mode plus
 */
#define LL_IIC_IC_FS_SCL_HCNT(n)                            (((n)&0xFFFF) << 0)
 ...
 *  fast mode plus
 */
#define LL_IIC_IC_FS_SCL_LCNT(n)                            (((n)&0xFFFF) << 0)
 ...
 */ 
#define LL_IIC_IC_HS_SCL_HCNT(n)                            (((n)&0xFFFF) << 0)
 ...
 */
#define LL_IIC_IC_HS_SCL_LCNT(n)                            (((n)&0xFFFF) << 0)


/***** IC_INTR_STAT(IIC Interrupt Status Register) *****/
/*! See IC_RAW_INTR_STAT for a detailed description of this bit.
 */
#define LL_IIC_INTR_STAT_R_SCL_STUCK_AT_LOW                 (1UL << 14)
/*! See IC_RAW_INTR_STAT on page 186 for a detailed description of this bit
 */
#define LL_IIC_INTR_STAT_R_MST_ON_HOLD                      (1UL << 13)
/*! See IC_RAW_INTR_STAT on page 186 for a detailed description of this bit
 */
#define LL_IIC_INTR_STAT_R_RESTART_DET                      (1UL << 12)
/*! See IC_RAW_INTR_STAT on page 186 for a detailed description of this bit
 */
#define LL_IIC_INTR_STAT_R_GEN_CALL                         (1UL << 11)
/*! See IC_RAW_INTR_STAT on page 186 for a detailed description of this bit
 */
#define LL_IIC_INTR_STAT_R_START_DET                        (1UL << 10)
/*! See IC_RAW_INTR_STAT on page 186 for a detailed description of this bit
 */
#define LL_IIC_INTR_STAT_R_STOP_DET                         (1UL << 9)
/*! See IC_RAW_INTR_STAT on page 186 for a detailed description of this bit
 */
#define LL_IIC_INTR_STAT_R_ACTIVITY                         (1UL << 8)
/*! See IC_RAW_INTR_STAT on page 186 for a detailed description of this bit
 */
#define LL_IIC_INTR_STAT_R_RX_DONE                          (1UL << 7)
/*! See IC_RAW_INTR_STAT on page 186 for a detailed description of this bit
 */
#define LL_IIC_INTR_STAT_R_TX_ABRT                          (1UL << 6)
/*! See IC_RAW_INTR_STAT on page 186 for a detailed description of this bit
 */
#define LL_IIC_INTR_STAT_R_RD_REQ                           (1UL << 5)
/*! See IC_RAW_INTR_STAT on page 186 for a detailed description of this bit
 */
#define LL_IIC_INTR_STAT_R_TX_EMPTY                         (1UL << 4)
/*! See IC_RAW_INTR_STAT on page 186 for a detailed description of this bit
 */
#define LL_IIC_INTR_STAT_R_TX_OVER                          (1UL << 3)
/*! See IC_RAW_INTR_STAT on page 186 for a detailed description of this bit
 */
#define LL_IIC_INTR_STAT_R_RX_FULL                          (1UL << 2)
/*! See IC_RAW_INTR_STAT on page 186 for a detailed description of this bit
 */
#define LL_IIC_INTR_STAT_R_RX_OVER                          (1UL << 1)
/*! See IC_RAW_INTR_STAT on page 186 for a detailed description of this bit
 */
#define LL_IIC_INTR_STAT_R_RX_UNDER                         (1UL << 0)
 ...
 */
#define LL_IIC_INTR_MASK_M_SCL_STUCK_AT_LOW                 (1UL << 14)
/*! This bit masks the R_MST_ON_HOLD interrupt bit in the IC_INTR_STAT register.
 */
#define LL_IIC_INTR_MASK_M_MST_ON_HOLD                      (1UL << 13)
/*! This bit masks the R_RESTART_DET interrupt status bit in the IC_INTR_STAT register
 */
#define LL_IIC_INTR_MASK_M_RESTART_DET                      (1UL << 12)
/*! These bits mask their corresponding interrupt status bits in the IC_INTR_STAT register
 */
#define LL_IIC_INTR_MASK_M_GEN_CALL                         (1UL << 11)
/*! These bits mask their corresponding interrupt status bits in the IC_INTR_STAT register
 */
#define LL_IIC_INTR_MASK_M_START_DET                        (1UL << 10)
/*! These bits mask their corresponding interrupt status bits in the IC_INTR_STAT register
 */
#define LL_IIC_INTR_MASK_M_STOP_DET                         (1UL << 9)
/*! These bits mask their corresponding interrupt status bits in the IC_INTR_STAT register
 */
#define LL_IIC_INTR_MASK_M_ACTIVITY                         (1UL << 8)
/*! These bits mask their corresponding interrupt status bits in the IC_INTR_STAT register
 */
#define LL_IIC_INTR_MASK_M_RX_DONE                          (1UL << 7)
/*! These bits mask their corresponding interrupt status bits in the IC_INTR_STAT register
 */
#define LL_IIC_INTR_MASK_M_TX_ABRT                          (1UL << 6)
/*! These bits mask their corresponding interrupt status bits in the IC_INTR_STAT register
 */
#define LL_IIC_INTR_MASK_M_RD_REQ                           (1UL << 5)
/*! These bits mask their corresponding interrupt status bits in the IC_INTR_STAT register
 */
#define LL_IIC_INTR_MASK_M_TX_EMPTY                         (1UL << 4)
/*! These bits mask their corresponding interrupt status bits in the IC_INTR_STAT register
 */
#define LL_IIC_INTR_MASK_M_TX_OVER                          (1UL << 3)
/*! These bits mask their corresponding interrupt status bits in the IC_INTR_STAT register
 */
#define LL_IIC_INTR_MASK_M_RX_FULL                          (1UL << 2)
/*! These bits mask their corresponding interrupt status bits in the IC_INTR_STAT register
 */
#define LL_IIC_INTR_MASK_M_RX_OVER                          (1UL << 1)
/*! These bits mask their corresponding interrupt status bits in the IC_INTR_STAT register
 */
#define LL_IIC_INTR_MASK_M_RX_UNDER                         (1UL << 0)
/*! These bits mask their corresponding interrupt status bits in the IC_INTR_STAT register
 */
#define LL_IIC_INTR_MASK(n)                                 (((n)&0x7FFF) << 0)
 ...
 */
#define LL_IIC_RAW_INTR_STAT_SCL_STUCK_AT_LOW               (1UL << 14)
 ...
 */
#define LL_IIC_RAW_INTR_STAT_MST_ON_HOLD                    (1UL << 13)
 ...
 */
#define LL_IIC_RAW_INTR_STAT_RESTART_DET                    (1UL << 12)
 ...
 */
#define LL_IIC_RAW_INTR_STAT_GEN_CALL                       (1UL << 11)
 ...
 */
#define LL_IIC_RAW_INTR_STAT_START_DET                      (1UL << 10)
 ...
 */
#define LL_IIC_RAW_INTR_STAT_STOP_DET                       (1UL << 9)
/*! This bit captures DW_apb_i2c activity and stays set until it is cleared
 */
#define LL_IIC_RAW_INTR_STAT_ACTIVITY                       (1UL << 8)
 ...
 */
#define LL_IIC_RAW_INTR_STAT_RX_DONE                        (1UL << 7)
 ...
 */
#define LL_IIC_RAW_INTR_STAT_TX_ABRT                        (1UL << 6)
 ...
 */
#define LL_IIC_RAW_INTR_STAT_TX_OVER                        (1UL << 3)
 ...
 */
#define LL_IIC_RAW_INTR_STAT_RX_FULL                        (1UL << 2)
 ...
 */
#define LL_IIC_RAW_INTR_STAT_RX_OVER                        (1UL << 1)
 ...
 */
#define LL_IIC_RAW_INTR_STAT_RX_UNDER                       (1UL << 0)
 ...
 *  the LL_IIC_RX_FULL interrupt(bit 2 in LL_IIC_IC_RAW_INTR_STAT register)
 */
#define LL_IIC_RX_TL(n)                                     (((n)&0xFF ) << 0)
 ...
 *  the LL_IIC_TX_EMPTY interrupt(bit 4 in LL_IIC_IC_RAW_INTR_STAT register)
 */
#define LL_IIC_TX_TL(n)                                     (((n)&0xFF) << 0)
 ...
 *  the LL_IIC_IC_TX_ABRT_SOURCE register
 */
#define LL_IIC_IC_CLR_INTR                                  (1UL << 0)


/***** IC_CLR_RX_UNDER(Clear RX_UNDER Interrupt Register) *****/
/*! Read this register to clear the RX_UNDER interrupt (bit 0) of the LL_IIC_IC_RAW_INTR_STAT 
 *  register
 */
#define LL_IIC_IC_CLR_RX_UNDER                              (1UL << 0)


/***** IC_CLR_RX_OVER(Clear RX_OVER Interrupt Register) *****/
/*! Read this register to clear the RX_OVER interrupt (bit 1) of the LL_IIC_IC_RAW_INTR_STAT 
 *  register 
 */
#define LL_IIC_IC_CLR_RX_OVER                               (1UL << 0)
 ...
 */
#define LL_IIC_IC_CLR_TX_OVER                               (1UL << 0)
 ...
 */
#define LL_IIC_IC_CLR_RD_REQ                                (1UL << 0)


/***** IC_CLR_TX_ABRT(Clear TX_ABRT Interrupt Register) *****/
/*! Read this register to clear the TX_ABRT interrupt (bit 6) of the LL_IIC_IC_RAW_INTR_STAT 
 *  register, and the IC_TX_ABRT_SOURCE register.
  */
#define LL_IIC_IC_CLR_TX_ABRT                               (1UL << 0)


/***** IC_CLR_RX_DONE(Clear RX_DONE Interrupt Register) *****/
/*! Read this register to clear the RX_DONE interrupt (bit 7) of the LL_IIC_IC_RAW_INTR_STAT 
 *  register 
 */
#define LL_IIC_IC_CLR_RX_DONE                               (1UL << 0)
 ...
 */
#define LL_IIC_IC_CLR_ACTIVITY                              (1UL << 0)


/***** IC_CLR_STOP_DET(Clear STOP_DET Interrupt Register) *****/
/*! Read this register to clear the STOP_DET interrupt (bit 9) of the LL_IIC_IC_RAW_INTR_STAT 
 *  register
 */
#define LL_IIC_IC_CLR_STOP_DET                              (1UL << 0)


/***** IC_CLR_START_DET(Clear START_DET Interrupt Register) *****/
/*! Read this register to clear the START_DET interrupt (bit 10) of the LL_IIC_IC_RAW_INTR_STAT 
 *  register
 */
#define LL_IIC_IC_CLR_START_DET                             (1UL << 0)


/***** IC_CLR_GEN_CALL(Clear GEN_CALL Interrupt Register) *****/
/*! Read this register to clear the GEN_CALL interrupt (bit 11) of LL_IIC_IC_RAW_INTR_STAT 
 *  register
 */
#define LL_IIC_IC_CLR_GEN_CALL                              (1UL << 0)


/***** IC_ENABLE(IIC Enable Register) *****/
/*! The SMBUS_ALERT_CTRL register bit is used to control assertion of SMBALERT signal
 */
#define LL_IIC_ENABLE_SMBUS_ALERT_EN                        (1UL << 18)
/*! The LL_IIC_SMBUS_SUSPEND_EN register bit is used to control assertion and deassertion of 
 *  SMBSUS signal
 */
#define LL_IIC_ENABLE_SMBUS_SUSPEND_EN                      (1UL << 17)
/*! This bit is used in SMBus Host mode to initiate the SMBus Master Clock Reset
 */
#define LL_IIC_ENABLE_SMBUS_CLK_RESET                       (1UL << 16)
 ...
 */
#define LL_IIC_ENABLE_SDA_STUCK_RECOVERY_ENABLE             (1UL << 3)
 ...
 */
#define LL_IIC_ENABLE_TX_CMD_BLOCK                          (1UL << 2)
/*! When set, the controller initiates the transfer abort
 */
#define LL_IIC_ENABLE_ABORT                                 (1UL << 1)
/*! Controls whether the DW_apb_i2c is enabled
 */
#define LL_IIC_ENABLE                                       (1UL << 0)
 ...
 */
#define LL_IIC_STATUS_SMBUS_ALERT_STATUS                    (1UL << 20)
 ...
 *  LL_IIC_IC_RX_FULL_HLD_BUS_EN is set to 1)
 */
#define LL_IIC_STATUS_SLV_HOLD_RX_FIFO_FULL                 (1UL << 10)
 ...
 */
#define LL_IIC_STATUS_SLV_HOLD_TX_FIFO_EMPTY                (1UL << 9)
/*! This bit indicates the BUS Hold in Master mode due to Rx FIFO is Full and additional byte 
 *  has been received(This kind of Bus hold is applicable if LL_IIC_IC_RX_FULL_HLD_BUS_EN is 
 *  set to 1)
 */
#define LL_IIC_STATUS_MST_HOLD_RX_FIFO_FULL                 (1UL << 8)
 ...
 *  (This kind of Bus hold is applicable if LL_IIC_IC_EMPTYFIFO_HOLD_MASTER_EN is set to 1)
 */
#define LL_IIC_STATUS_MST_HOLD_TX_FIFO_EMPTY                (1UL << 7)
/*! Slave FSM Activity Status. When the Slave Finite State Machine (FSM) is not in the IDLE 
 *  state, this bit is set
 */
#define LL_IIC_STATUS_SLV_ACTIVITY                          (1UL << 6)
/*! Master FSM Activity Status. When the Master Finite State Machine (FSM) is not in the IDLE 
 *  state, this bit is set
 */
#define LL_IIC_STATUS_MST_ACTIVITY                          (1UL << 5)
 ...
 */
#define LL_IIC_STATUS_RFF                                   (1UL << 4)
 ...
 */
#define LL_IIC_STATUS_RFNE                                  (1UL << 3)
 ...
 */
#define LL_IIC_STATUS_TFE                                   (1UL << 2)
 ...
 *  and TDMAE = 1
 */
#define LL_IIC_DMA_TDLR(n)                                  (((n)&0xFF) << 0)
 ...
 */
#define LL_IIC_DMA_RDLR(n)                                  (((n)&0xFF) << 0)
 ...
 *  minimum value of 2 
 */
#define LL_IIC_SDA_SETUP(n)                                 (((n)&0xFF) << 0)
 ...
 */
#define LL_IIC_ACK_GEN_CALL                                 (1UL << 0)
 ...
 */
#define LL_IIC_SLV_RX_DATA_LOST                             (1UL << 2)
 ...
 */
#define LL_IIC_IC_FS_SPKLEN(n)                              (((n)&0xFF) << 0)
 ...
 *  lines that are filtered out by the spike suppression logic;  
 */
#define LL_IIC_IC_HS_SPKLEN(n)                              (((n)&0xFF) << 0)
 ...
 */
#define LL_IIC_CLR_RESTART_DET                              (1UL << 0)
 ...
 *  notes 
 */
#define LL_IIC_IC_COMP_VERSION(n)                           (((n)&0xFFFFFFFF) << 0)
 ...
 */
#define LL_IIC_ IC_COMP_TYPE(n)                             (((n)&0xFFFFFFFF) << 0)
 ...
 */
#define LL_IIC_IC_SCL_STUCK_LOW_TIMEOUT(n)                  (((n)&0xFFFFFFFF) << 0)
 ...
 */
#define LL_IIC_IC_SDA_STUCK_LOW_TIMEOUT(n)                  (((n)&0xFFFFFFFF) << 0)
 ...
 */
#define LL_IIC_CLR_SCL_STUCK                                (1UL << 0)
 ...
 */
#define LL_IIC_DEVICE_ID(n)                                 (((n)&0xFFFFFF) << 0)
 ...
 */
#define LL_IIC_IC_UFM_SCL_HCNT(n)                           (((n)&0xFFFF) << 0)
 ...
 */
#define LL_IIC_IC_UFM_SCL_LCNT(n)                           (((n)&0xFFFF) << 0)
 ...
 *  lines that are filtered out by the spike suppression logic. 
 */
#define LL_IIC_IC_UFM_SPKLEN(n)                             (((n)&0xFF) << 0)
 ...
 */
#define LL_IIC_IC_UFM_TBUF_CNT(n)                           (((n)&0xFFFF) << 0)
 ...
 */
#define LL_IIC_SMBUS_CLK_LOW_SEXT_TIMEOUT(n)                (((n)&0xFFFFFFFF) << 0)
 ...
 */
#define LL_IIC_SMBUS_CLK_LOW_MEXT_TIMEOUT(n)                (((n)&0xFFFFFFFF) << 0)
 ...
 */
#define LL_IIC_SMBUS_THIGH_MAX_BUS_IDLE_CNT(n)              (((n)&0xFFFF) << 0)
 ...
 */
#define LL_IIC_R_SMBUS_ALERT_DET                            (1UL << 10) 
/*! See IC_SMBUS_INTR_RAW_STATUS for a detailed description of this bit 
 */
#define LL_IIC_R_SMBUS_SUSPEND_DET                          (1UL << 9)
/*! See IC_SMBUS_INTR_RAW_STATUS for a detailed description of this bit 
 */
#define LL_IIC_R_SLV_RX_PEC_NACK                            (1UL << 8)
/*! See IC_SMBUS_INTR_RAW_STATUS for a detailed description of this bit 
 */
#define LL_IIC_R_ARP_ASSGN_ADDR_CMD_DET                     (1UL << 7)
/*! See IC_SMBUS_INTR_RAW_STATUS for a detailed description of this bit 
 */
#define LL_IIC_R_ARP_GET_UDID_CMD_DET                       (1UL << 6)
/*! See IC_SMBUS_INTR_RAW_STATUS for a detailed description of this bit 
 */
#define LL_IIC_R_ARP_RST_CMD_DET                            (1UL << 5)
/*! See IC_SMBUS_INTR_RAW_STATUS for a detailed description of this bit 
 */
#define LL_IIC_R_ARP_PREPARE_CMD_DET                        (1UL << 4)
/*! See IC_SMBUS_INTR_RAW_STATUS for a detailed description of this bit 
 */
#define LL_IIC_R_HOST_NOTIFY_MST_DET                        (1UL << 3)
/*! See IC_SMBUS_INTR_RAW_STATUS for a detailed description of this bit 
 */
#define LL_IIC_R_QUICK_CMD_DET                              (1UL << 2)
/*! See IC_SMBUS_INTR_RAW_STATUS for a detailed description of this bit 
 */
#define LL_IIC_R_MST_CLOCK_EXTND_TIMEOUT                    (1UL << 1)
/*! See IC_SMBUS_INTR_RAW_STATUS for a detailed description of this bit 
 */
#define LL_IIC_R_SLV_CLOCK_EXTND_TIMEOUT                    (1UL << 0)
 ...
 *  to 1 
 */
#define LL_IIC_QUICK_CMD_DET                                (1UL << 2)
 ...
 */
#define LL_IIC_IC_OPTIONAL_SAR(n)                           (((n)&0x7F) << 0)
 ...
 *  Resolution Protocol 
 */
#define LL_IIC_IC_SMBUS_ARP_UDID_LSB(n)                     (((n)&0xFFFFFFFF) << 0)
...
/**
  * @brief Enumeration constant for low layer IIC type of timer IO map
  */
typedef enum {
    /*! Select the pin of the IIC io map0
     */
    LL_IIC_IO_MAP0       = 0x01,
    /*! Select the pin of the IIC Smbus io map0
     */
    LL_IIC_IO_SMBUS_MAP0 = 0x02,
    /*! Select the pin of the IIC Smbus io map1
     */
    LL_IIC_IO_SMBUS_MAP1 = 0x04,
}TYPE_ENUM_LL_IIC_IO_MAP;
...
typedef enum {
     ...
     */
    LL_IIC_SPEED_STANDARD_MODE = 1, 
    /*! 2: fast mode (= 400 Kb/s) or fast mode plus (= 1000 Kb/s)
     */
    LL_IIC_SPEED_MODE,
    /*! 3: high speed mode (= 3.4 Mb/s)
     */
    LL_IIC_SPEED_HIGH_MODE,
} TYPE_ENUM_LL_IIC_SPEED_SEL;
...
typedef enum {
     ...
     */
    LL_IIC_MODE_MASTER = 0,
    /*! IIC selects the slave mode.
     */
    LL_IIC_MODE_SLAVE,
} TYPE_ENUM_LL_IIC_MODE_SEL;
...
typedef struct _ll_iic_cfg {
     ...
     */
    TYPE_ENUM_LL_IIC_MODE_SEL  mode_sel;
    /*! Configure the baud rate of iic.
     */
    u32                        baudrate;
    /*! Controls whether responds to 7- or 10-bit addresses as slave/master
     */
    TYPE_ENUM_LL_IIC_ADDR_SEL  addr_sel;
     ...
     * ©¸©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©Ø©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©Ø©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©Ø©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¼
     */
    TYPE_ENUM_LL_IIC_IO_MAP    io_map;
} TYPE_LL_IIC_CFG;
...
/**
  ...
  * @param  p_iic: The structure pointer of the IIC group (IIC0, IIC1) is selected.
  * @param  p_cfg: Module configuration structure pointer(TYPE_LL_IIC_DMA_CFG)
  * @retval None
  */
...
/**
  * @brief  Timing of IIC, send start signal + address value(8 bit).
  * @param  p_iic: Select the initialized IIC group pointer
  * @param  addr : the addr of IIC slave where you want to read, 
  *                The address value is 2byte.
  * @retval None
  */
#define LL_IIC_TIMING_RESTART_ADDRESS_8(p_iic, addr)                       \
do {                                                                       \
    p_iic->DATA_CMD = LL_IIC_DATA_CMD_RESTART | LL_IIC_DATA_CMD_DAT(addr); \
} while(0)

/**
  * @brief  Timing of IIC, send start signal + address value(16 bit).
  * @param  p_iic: Select the initialized IIC group pointer
  * @param  addr : the addr of IIC slave where you want to read, 
  *                The address value is 2byte.
  * @retval None
  */
#define LL_IIC_TIMING_RESTART_ADDRESS_16(p_iic, addr)                           \
do {                                                                            \
    p_iic->DATA_CMD = LL_IIC_DATA_CMD_RESTART | LL_IIC_DATA_CMD_DAT(addr >> 8); \
    p_iic->DATA_CMD = LL_IIC_DATA_CMD_DAT(addr);                                \
} while(0)

/**
  * @brief  Timing of IIC, send start signal + address value(8*n bit).
  * @param  p_iic: Select the initialized IIC group pointer
  * @param  addr : the addr of IIC slave where you want to read, 
  *                The address format is (low address in addr[0]).
  * @param  len  : the addr length of IIC slave where you want to read, 
  *                The address format is (low address in addr[0]).
  * @retval None
  */
#define LL_IIC_TIMING_RESTART_ADDRESS(p_iic, addr, len)                          \
do {                                                                             \
    u8 *p_addr_buf = addr;                                                       \
    p_iic->DATA_CMD = LL_IIC_DATA_CMD_RESTART | LL_IIC_DATA_CMD_DAT(p_addr_buf); \
    p_addr_buf++;                                                                \
    len--;                                                                       \
    while(len > 0) {                                                             \
        p_iic->DATA_CMD = LL_IIC_DATA_CMD_DAT(p_addr_buf);                       \
        p_buf++;                                                                 \
        len--;                                                                   \
    }                                                                            \
} while(0)
...
/**
  ...
  * @retval None
  */
#define LL_IIC_TIMING_RESTART_READ_STOP(p_iic)  \
do {                                            \
    p_iic->DATA_CMD = LL_IIC_DATA_CMD_RESTART | \
                      LL_IIC_DATA_CMD_STOP    | \
                      LL_IIC_DATA_CMD_CMD;      \
} while(0)
...
/**
  ...
  * @retval None
  */
#define LL_IIC_TIMING_RESTART_READ(p_iic)       \
do {                                            \
    p_iic->DATA_CMD = LL_IIC_DATA_CMD_RESTART | \
                      LL_IIC_DATA_CMD_CMD;      \
} while(0)
...
/**
  ...
  * @retval None
  */
#define LL_IIC_TIMING_READ(p_iic)          \
do {                                       \
    p_iic->DATA_CMD = LL_IIC_DATA_CMD_CMD; \
} while(0)
...
/**
  ...
  * @retval None
  */
#define LL_IIC_TIMING_READ_STOP(p_iic)       \
do {                                         \
    p_iic->DATA_CMD = LL_IIC_DATA_CMD_STOP | \
                      LL_IIC_DATA_CMD_CMD;   \
} while(0)
...
/**
  ...
  * @retval None
  */
#define LL_IIC_TIMING_WRITE(p_iic, data) \
do {                                     \
    p_iic->DATA_CMD = data;              \
} while(0)
...
/**
  ...
  * @retval None
  */
#define LL_IIC_TIMING_GET_READ_DATA(p_iic, data) \
do {                                             \
    data = (u8)p_iic->DATA_CMD;                  \
} while(0)
...
/**
  ...
  * @retval None
  */
#define LL_IIC_TIMING_WRITE_STOP(p_iic, data)      \
do {                                               \
    p_iic->DATA_CMD = data | LL_IIC_DATA_CMD_STOP; \
} while(0)
...
/**
  ...
  * @retval None
  */
#define LL_IIC_GET_INTERRPT_PENDING(p_iic)                      ((p_iic)->INTR_STAT)
...
/**
  ...
  * @retval None
  */
#define LL_IIC_CHECK_RX_UNDER_INTERRUPT_ENABLE(p_iic)           ((p_iic)->INTR_MASK & LL_IIC_INTR_MASK_M_RX_UNDER)
...
/**
  ...
  * @retval None
  */
#define LL_IIC_CHECK_RX_OVER_INTERRUPT_ENABLE(p_iic)            ((p_iic)->INTR_MASK & LL_IIC_INTR_MASK_M_RX_OVER)
...
/**
  ...
  * @retval None
  */
#define LL_IIC_CHECK_RX_FULL_INTERRUPT_ENABLE(p_iic)            ((p_iic)->INTR_MASK & LL_IIC_INTR_MASK_M_RX_FULL)
...
/**
  ...
  * @retval None
  */
#define LL_IIC_CHECK_TX_OVER_INTERRUPT_ENABLE(p_iic)            ((p_iic)->INTR_MASK & LL_IIC_INTR_MASK_M_TX_OVER)
...
/**
  ...
  * @retval None
  */
#define LL_IIC_CHECK_TX_EMPTY_INTERRUPT_ENABLE(p_iic)           ((p_iic)->INTR_MASK & LL_IIC_INTR_MASK_M_TX_EMPTY)
...
/**
  ...
  * @retval None
  */
#define LL_IIC_CHECK_READ_REQ_INTERRUPT_ENABLE(p_iic)           ((p_iic)->INTR_MASK & LL_IIC_INTR_MASK_M_RD_REQ)
...
/**
  ...
  * @retval None
  */
#define LL_IIC_CHECK_TX_ABRT_INTERRUPT_ENABLE(p_iic)            ((p_iic)->INTR_MASK & LL_IIC_INTR_MASK_M_TX_ABRT)
...
/**
  ...
  * @retval None
  */
#define LL_IIC_CHECK_RX_DONE_INTERRUPT_ENABLE(p_iic)            ((p_iic)->INTR_MASK & LL_IIC_INTR_MASK_M_RX_DONE)
...
/**
  ...
  * @retval None
  */
#define LL_IIC_CHECK_ACTIVITY_INTERRUPT_ENABLE(p_iic)           ((p_iic)->INTR_MASK & LL_IIC_INTR_MASK_M_ACTIVITY)
...
/**
  ...
  * @retval None
  */
#define LL_IIC_CHECK_STOP_DET_INTERRUPT_ENABLE(p_iic)           ((p_iic)->INTR_MASK & LL_IIC_INTR_MASK_M_STOP_DET)
...
/**
  ...
  * @retval None
  */
#define LL_IIC_CHECK_START_DET_INTERRUPT_ENABLE(p_iic)          ((p_iic)->INTR_MASK & LL_IIC_INTR_MASK_M_START_DET)
...
/**
  ...
  * @retval None
  */
#define LL_IIC_CHECK_GEN_CALL_INTERRUPT_ENABLE(p_iic)           ((p_iic)->INTR_MASK & LL_IIC_INTR_MASK_M_GEN_CALL)
...
/**
  ...
  * @retval None
  */
#define LL_IIC_CHECK_RESTART_DET_INTERRUPT_ENABLE(p_iic)        ((p_iic)->INTR_MASK & LL_IIC_INTR_MASK_M_RESTART_DET)
...
/**
  ...
  * @retval None
  */
#define LL_IIC_CHECK_MST_ON_HOLD_INTERRUPT_ENABLE(p_iic)        ((p_iic)->INTR_MASK & LL_IIC_INTR_MASK_M_MST_ON_HOLD)
...
/**
  ...
  * @retval None
  */
#define LL_IIC_CHECK_SCL_STUCK_AT_LOW_INTERRUPT_ENABLE(p_iic)   ((p_iic)->INTR_MASK & LL_IIC_INTR_MASK_M_SCL_STUCK_AT_LOW)
...
/**
  ...
  */
#define LL_IIC_GET_STATUS_ACTIVITY(p_iic)                       ((p_iic)->STATUS & LL_IIC_STATUS_ACTIVITY)
...
/**
  ...
  * @retval pending value
  */
#define LL_IIC_GET_STATUS_TX_FIFO_NO_FULL(p_iic)                ((p_iic)->STATUS & LL_IIC_STATUS_TFNF)
...
/**
  ...
  * @retval pending value
  */
#define LL_IIC_GET_STATUS_TX_FIFO_EMPTY(p_iic)                  ((p_iic)->STATUS & LL_IIC_STATUS_TFE)
...
/**
  ...
  * @retval pending value
  */
#define LL_IIC_GET_STATUS_RX_FIFO_NO_EMPTY(p_iic)               ((p_iic)->STATUS & LL_IIC_STATUS_RFNE)
...
/**
  ...
  * @retval pending value
  */
#define LL_IIC_GET_STATUS_RX_FIFO_FULL(p_iic)                   ((p_iic)->STATUS & LL_IIC_STATUS_RFF)
...
/**
  ...
  * @retval pending value
  */
#define LL_IIC_GET_STATUS_MST_ACTIVITY(p_iic)                   ((p_iic)->STATUS & LL_IIC_STATUS_MST_ACTIVITY)
...
/**
  ...
  * @retval pending value
  */
#define LL_IIC_GET_STATUS_SLV_ACTIVITY(p_iic)                   ((p_iic)->STATUS & LL_IIC_STATUS_SLV_ACTIVITY)
...
/**
  ...
  * @retval pending value
  */
#define LL_IIC_GET_STATUS_MST_HOLD_TX_FIFO_EMPTY(p_iic)         ((p_iic)->STATUS & LL_IIC_STATUS_MST_HOLD_TX_FIFO_EMPTY)
...
/**
  ...
  * @retval pending value
  */
#define LL_IIC_GET_STATUS_MST_HOLD_RX_FIFO_FULL(p_iic)          ((p_iic)->STATUS & LL_IIC_STATUS_MST_HOLD_RX_FIFO_FULL)
...
/**
  ...
  * @retval pending value
  */
#define LL_IIC_GET_STATUS_SLV_HOLD_TX_FIFO_EMPTY(p_iic)         ((p_iic)->STATUS & LL_IIC_STATUS_SLV_HOLD_TX_FIFO_EMPTY)
...
/**
  ...
  * @retval pending value
  */
#define LL_IIC_GET_STATUS_SLV_HOLD_RX_FIFO_FULL(p_iic)          ((p_iic)->STATUS & LL_IIC_STATUS_SLV_HOLD_RX_FIFO_FULL)
...
/**
  ...
  * @retval pending value
  */
#define LL_IIC_GET_STATUS_SDA_STUCK_NOT_RECOVERED(p_iic)        ((p_iic)->STATUS & LL_IIC_STATUS_SDA_STUCK_NOT_RECOVERED)
...
/**
  ...
  * @retval pending value
  */
#define LL_IIC_GET_STATUS_SMBUS_QUICK_CMD_BIT(p_iic)            ((p_iic)->STATUS & LL_IIC_STATUS_SMBUS_QUICK_CMD_BIT)
...
/**
  ...
  * @retval pending value
  */
#define LL_IIC_GET_STATUS_SMBUS_SLAVE_ADDR_VALID(p_iic)         ((p_iic)->STATUS & LL_IIC_STATUS_SMBUS_SLAVE_ADDR_VALID)
...
/**
  ...
  * @retval pending value
  */
#define LL_IIC_GET_STATUS_SMBUS_SLAVE_ADDR_RESOLVED(p_iic)      ((p_iic)->STATUS & LL_IIC_STATUS_SMBUS_SLAVE_ADDR_RESOLVED)
...
/**
  ...
  * @retval pending value
  */
#define LL_IIC_GET_STATUS_SMBUS_SUSPEND_STATUS(p_iic)           ((p_iic)->STATUS & LL_IIC_STATUS_SMBUS_SUSPEND_STATUS)
...
/**
  ...
  * @retval pending value
  */
#define LL_IIC_GET_STATUS_SMBUS_ALERT_STATUS(p_iic)             ((p_iic)->STATUS & LL_IIC_STATUS_SMBUS_ALERT_STATUS)
...
/**
  ...
  * @retval None
  */
#define LL_IIC_GET_RX_UNDER_PENDING(p_iic)                      ((p_iic)->INTR_STAT & LL_IIC_INTR_STAT_R_RX_UNDER)
...
/**
  ...
  * @retval None
  */
#define LL_IIC_GET_RX_OVER_PENDING(p_iic)                       ((p_iic)->INTR_STAT & LL_IIC_INTR_STAT_R_RX_OVER)
...
/**
  ...
  * @retval None
  */
#define LL_IIC_GET_RX_FULL_PENDING(p_iic)                       ((p_iic)->INTR_STAT & LL_IIC_INTR_STAT_R_RX_FULL)
...
/**
  ...
  * @retval None
  */
#define LL_IIC_GET_TX_OVER_PENDING(p_iic)                       ((p_iic)->INTR_STAT & LL_IIC_INTR_STAT_R_TX_OVER)
...
/**
  ...
  * @retval None
  */
#define LL_IIC_GET_TX_EMPTY_PENDING(p_iic)                      ((p_iic)->INTR_STAT & LL_IIC_INTR_STAT_R_TX_EMPTY)
...
/**
  ...
  * @retval None
  */
#define LL_IIC_GET_READ_REQ_PENDING(p_iic)                      ((p_iic)->INTR_STAT & LL_IIC_INTR_STAT_R_RD_REQ)
...
/**
  ...
  * @retval None
  */
#define LL_IIC_GET_TX_ABRT_PENDING(p_iic)                       ((p_iic)->INTR_STAT & LL_IIC_INTR_STAT_R_TX_ABRT)
...
/**
  ...
  * @retval None
  */
#define LL_IIC_GET_RX_DONE_PENDING(p_iic)                       ((p_iic)->INTR_STAT & LL_IIC_INTR_STAT_R_RX_DONE)
...
/**
  ...
  * @retval None
  */
#define LL_IIC_GET_ACTIVITY_PENDING(p_iic)                      ((p_iic)->INTR_STAT & LL_IIC_INTR_STAT_R_ACTIVITY)
...
/**
  ...
  * @retval None
  */
#define LL_IIC_GET_STOP_DET_PENDING(p_iic)                      ((p_iic)->INTR_STAT & LL_IIC_INTR_STAT_R_STOP_DET)
...
/**
  ...
  * @retval None
  */
#define LL_IIC_GET_START_DET_PENDING(p_iic)                     ((p_iic)->INTR_STAT & LL_IIC_INTR_STAT_R_START_DET)
...
/**
  ...
  * @retval None
  */
#define LL_IIC_GET_GEN_CALL_PENDING(p_iic)                      ((p_iic)->INTR_STAT & LL_IIC_INTR_STAT_R_GEN_CALL)
...
/**
  ...
  * @retval None
  */
#define LL_IIC_GET_MST_ON_HOLD_PENDING(p_iic)                   ((p_iic)->INTR_STAT & LL_IIC_INTR_STAT_R_MST_ON_HOLD)
...
/**
  ...
  * @retval None
  */
#define LL_IIC_GET_RESTART_DET_PENDING(p_iic)                   ((p_iic)->INTR_STAT & LL_IIC_INTR_STAT_R_RESTART_DET)
...
/**
  ...
  * @retval None
  */
#define LL_IIC_GET_SCL_STUCK_AT_LOW_PENDING(p_iic)              ((p_iic)->INTR_STAT & LL_IIC_INTR_STAT_R_SCL_STUCK_AT_LOW)
...
/**
  ...
  * @retval None
  */
#define LL_IIC_GET_RAW_RX_UNDER_PENDING(p_iic)                  ((p_iic)->RAW_INTR_STAT & LL_IIC_RAW_INTR_STAT_RX_UNDER)
...
/**
  ...
  * @retval None
  */
#define LL_IIC_GET_RAW_RX_OVER_PENDING(p_iic)                   ((p_iic)->RAW_INTR_STAT & LL_IIC_RAW_INTR_STAT_RX_OVER)
...
/**
  ...
  * @retval None
  */
#define LL_IIC_GET_RAW_RX_FULL_PENDING(p_iic)                   ((p_iic)->RAW_INTR_STAT & LL_IIC_RAW_INTR_STAT_RX_FULL)
...
/**
  ...
  * @retval None
  */
#define LL_IIC_GET_RAW_TX_OVER_PENDING(p_iic)                   ((p_iic)->RAW_INTR_STAT & LL_IIC_RAW_INTR_STAT_TX_OVER)
...
/**
  ...
  * @retval None
  */
#define LL_IIC_GET_RAW_TX_EMPTY_PENDING(p_iic)                  ((p_iic)->RAW_INTR_STAT & LL_IIC_RAW_INTR_STAT_TX_EMPTY)
...
/**
  ...
  * @retval None
  */
#define LL_IIC_GET_RAW_READ_REQ_PENDING(p_iic)                  ((p_iic)->RAW_INTR_STAT & LL_IIC_RAW_INTR_STAT_RD_REQ)
...
/**
  ...
  * @retval None
  */
#define LL_IIC_GET_RAW_TX_ABRT_PENDING(p_iic)                   ((p_iic)->RAW_INTR_STAT & LL_IIC_RAW_INTR_STAT_TX_ABRT)
...
/**
  ...
  * @retval None
  */
#define LL_IIC_GET_RAW_RX_DONE_PENDING(p_iic)                   ((p_iic)->RAW_INTR_STAT & LL_IIC_RAW_INTR_STAT_RX_DONE)
...
/**
  ...
  * @retval None
  */
#define LL_IIC_GET_RAW_ACTIVITY_PENDING(p_iic)                  ((p_iic)->RAW_INTR_STAT & LL_IIC_RAW_INTR_STAT_ACTIVITY)
...
/**
  ...
  * @retval None
  */
#define LL_IIC_GET_RAW_STOP_DET_PENDING(p_iic)                  ((p_iic)->RAW_INTR_STAT & LL_IIC_RAW_INTR_STAT_STOP_DET)
...
/**
  ...
  * @retval None
  */
#define LL_IIC_GET_RAW_START_DET_PENDING(p_iic)                 ((p_iic)->RAW_INTR_STAT & LL_IIC_RAW_INTR_STAT_START_DET)
...
/**
  ...
  * @retval None
  */
#define LL_IIC_GET_RAW_GEN_CALL_PENDING(p_iic)                  ((p_iic)->RAW_INTR_STAT & LL_IIC_RAW_INTR_STAT_GEN_CALL)
...
/**
  ...
  * @retval None
  */
#define LL_IIC_GET_RAW_RESTART_DET_PENDING(p_iic)               ((p_iic)->RAW_INTR_STAT & LL_IIC_RAW_INTR_STAT_RESTART_DET)
...
/**
  ...
  * @retval None
  */
#define LL_IIC_GET_RAW_MST_ON_HOLD_PENDING(p_iic)               ((p_iic)->RAW_INTR_STAT & LL_IIC_RAW_INTR_STAT_MST_ON_HOLD)
...
/**
  ...
  * @retval None
  */
#define LL_IIC_GET_RAW_SCL_STUCK_AT_LOW_PENDING(p_iic)          ((p_iic)->RAW_INTR_STAT & LL_IIC_RAW_INTR_STAT_SCL_STUCK_AT_LOW)
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void ll_iic_clear_rx_under_pending(IIC_TypeDef *p_iic) {
    p_iic->CLR_RX_UNDER = p_iic->CLR_RX_UNDER;
}
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void ll_iic_clear_rx_over_pending(IIC_TypeDef *p_iic) {
    p_iic->CLR_RX_OVER = p_iic->CLR_RX_OVER;
}
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void ll_iic_clear_rx_full_pending(IIC_TypeDef *p_iic) {
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void ll_iic_clear_tx_over_pending(IIC_TypeDef *p_iic) {
    p_iic->CLR_TX_OVER = p_iic->CLR_TX_OVER;
}
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void ll_iic_clear_tx_empty_pending(IIC_TypeDef *p_iic) {
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void ll_iic_clear_read_req_pending(IIC_TypeDef *p_iic) {
    p_iic->CLR_RD_REQ = p_iic->CLR_RD_REQ;
}
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void ll_iic_clear_tx_abrt_pending(IIC_TypeDef *p_iic) {
    p_iic->CLR_TX_ABRT = p_iic->CLR_TX_ABRT;
}
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void ll_iic_clear_rx_done_pending(IIC_TypeDef *p_iic) {
    p_iic->CLR_RX_DONE = p_iic->CLR_RX_DONE;
}
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void ll_iic_clear_activity_pending(IIC_TypeDef *p_iic) {
    p_iic->CLR_ACTIVITY = p_iic->CLR_ACTIVITY;
}
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void ll_iic_clear_stop_det_pending(IIC_TypeDef *p_iic) {
    p_iic->CLR_STOP_DET = p_iic->CLR_STOP_DET;
}
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void ll_iic_clear_start_det_pending(IIC_TypeDef *p_iic) {
    p_iic->CLR_START_DET = p_iic->CLR_START_DET;
}
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void ll_iic_clear_gen_call_pending(IIC_TypeDef *p_iic) {
    p_iic->CLR_GEN_CALL = p_iic->CLR_GEN_CALL;
}
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void ll_iic_clear_restart_det_pending(IIC_TypeDef *p_iic) {
    p_iic->CLR_RESTART_DET = p_iic->CLR_RESTART_DET;
}
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void ll_iic_clear_master_on_hold_pending(IIC_TypeDef *p_iic) {
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void ll_iic_clear_stuck_at_low_pending(IIC_TypeDef *p_iic) {
    p_iic->CLR_SCL_STUCK_DET = p_iic->CLR_SCL_STUCK_DET;
}

/**
  * @brief  IIC module enable recevied under interrupt
  * @param  p_iic: Select the initialized IIC group pointer
  * @retval None
  */
__STATIC_INLINE void ll_iic_rx_under_interrupt_enable(IIC_TypeDef *p_iic) {
    p_iic->INTR_MASK |= LL_IIC_INTR_MASK_M_RX_UNDER;
}

/**
  * @brief  IIC module disable recevied under interrupt
  * @param  p_iic: Select the initialized IIC group pointer
  * @retval None
  */
__STATIC_INLINE void ll_iic_rx_under_interrupt_disable(IIC_TypeDef *p_iic) {
    p_iic->INTR_MASK &= ~(LL_IIC_INTR_MASK_M_RX_UNDER);
}

/**
  * @brief  IIC module enable rx buffer overflow up interrupt
  * @param  p_iic: Select the initialized IIC group pointer
  * @retval None
  */
__STATIC_INLINE void ll_iic_rx_over_interrupt_enable(IIC_TypeDef *p_iic) {
    p_iic->INTR_MASK |= LL_IIC_INTR_MASK_M_RX_OVER;
}

/**
  * @brief  IIC module disable rx buffer overflow up interrupt
  * @param  p_iic: Select the initialized IIC group pointer
  * @retval None
  */
__STATIC_INLINE void ll_iic_rx_over_interrupt_disable(IIC_TypeDef *p_iic) {
    p_iic->INTR_MASK &= ~(LL_IIC_INTR_MASK_M_RX_OVER);
}

/**
  * @brief  IIC module enable rx buffer full interrupt
  * @param  p_iic: Select the initialized IIC group pointer
  * @retval None
  */
__STATIC_INLINE void ll_iic_rx_full_interrupt_enable(IIC_TypeDef *p_iic) {
    p_iic->INTR_MASK |= LL_IIC_INTR_MASK_M_RX_FULL;
}

/**
  * @brief  IIC module disable rx buffer full interrupt
  * @param  p_iic: Select the initialized IIC group pointer
  * @retval None
  */
__STATIC_INLINE void ll_iic_rx_full_interrupt_disable(IIC_TypeDef *p_iic) {
    p_iic->INTR_MASK &= ~(LL_IIC_INTR_MASK_M_RX_FULL);
}

/**
  * @brief  IIC module enable tx buffer overflow interrupt
  * @param  p_iic: Select the initialized IIC group pointer
  * @retval None
  */
__STATIC_INLINE void ll_iic_tx_over_interrupt_enable(IIC_TypeDef *p_iic) {
    p_iic->INTR_MASK |= LL_IIC_INTR_MASK_M_TX_OVER;
}

/**
  * @brief  IIC module disable tx buffer overflow interrupt
  * @param  p_iic: Select the initialized IIC group pointer
  * @retval None
  */
__STATIC_INLINE void ll_iic_tx_over_interrupt_disable(IIC_TypeDef *p_iic) {
    p_iic->INTR_MASK &= ~(LL_IIC_INTR_MASK_M_TX_OVER);
}

/**
  * @brief  IIC module enable tx buffer empty interrupt
  * @param  p_iic: Select the initialized IIC group pointer
  * @retval None
  */
__STATIC_INLINE void ll_iic_tx_empty_interrupt_enable(IIC_TypeDef *p_iic) {
    p_iic->INTR_MASK |= LL_IIC_INTR_MASK_M_TX_EMPTY;
}

/**
  * @brief  IIC module disable tx buffer empty interrupt
  * @param  p_iic: Select the initialized IIC group pointer
  * @retval None
  */
__STATIC_INLINE void ll_iic_tx_empty_interrupt_disable(IIC_TypeDef *p_iic) {
    p_iic->INTR_MASK &= ~(LL_IIC_INTR_MASK_M_TX_EMPTY);
}

/**
  * @brief  IIC module enable read request interrupt
  * @param  p_iic: Select the initialized IIC group pointer
  * @retval None
  */
__STATIC_INLINE void ll_iic_read_req_interrupt_enable(IIC_TypeDef *p_iic) {
    p_iic->INTR_MASK |= LL_IIC_INTR_MASK_M_RD_REQ;
}

/**
  * @brief  IIC module disable read request interrupt
  * @param  p_iic: Select the initialized IIC group pointer
  * @retval None
  */
__STATIC_INLINE void ll_iic_read_req_interrupt_disable(IIC_TypeDef *p_iic) {
    p_iic->INTR_MASK &= ~(LL_IIC_INTR_MASK_M_RD_REQ);
}

/**
  * @brief  IIC module enable tx abrt interrupt
  * @param  p_iic: Select the initialized IIC group pointer
  * @retval None
  */
__STATIC_INLINE void ll_iic_tx_abrt_interrupt_enable(IIC_TypeDef *p_iic) {
    p_iic->INTR_MASK |= LL_IIC_INTR_MASK_M_TX_ABRT;
}

/**
  * @brief  IIC module disable tx abrt interrupt
  * @param  p_iic: Select the initialized IIC group pointer
  * @retval None
  */
__STATIC_INLINE void ll_iic_tx_abrt_interrupt_disable(IIC_TypeDef *p_iic) {
    p_iic->INTR_MASK &= ~(LL_IIC_INTR_MASK_M_TX_ABRT);
}

/**
  * @brief  IIC module enable rx done interrupt
  * @param  p_iic: Select the initialized IIC group pointer
  * @retval None
  */
__STATIC_INLINE void ll_iic_rx_done_interrupt_enable(IIC_TypeDef *p_iic) {
    p_iic->INTR_MASK |= LL_IIC_INTR_MASK_M_RX_DONE;
}

/**
  * @brief  IIC module disable rx done interrupt
  * @param  p_iic: Select the initialized IIC group pointer
  * @retval None
  */
__STATIC_INLINE void ll_iic_rx_done_interrupt_disable(IIC_TypeDef *p_iic) {
    p_iic->INTR_MASK &= ~(LL_IIC_INTR_MASK_M_RX_DONE);
}

/**
  * @brief  IIC module enable DW_apb_i2c activity interrupt
  * @param  p_iic: Select the initialized IIC group pointer
  * @retval None
  */
__STATIC_INLINE void ll_iic_activity_interrupt_enable(IIC_TypeDef *p_iic) {
    p_iic->INTR_MASK |= LL_IIC_INTR_MASK_M_ACTIVITY;
}

/**
  * @brief  IIC module disable DW_apb_i2c activity interrupt
  * @param  p_iic: Select the initialized IIC group pointer
  * @retval None
  */
__STATIC_INLINE void ll_iic_activity_interrupt_disable(IIC_TypeDef *p_iic) {
    p_iic->INTR_MASK &= ~(LL_IIC_INTR_MASK_M_ACTIVITY);
}

/**
  * @brief  IIC module enable stop condition detect interrupt
  * @param  p_iic: Select the initialized IIC group pointer
  * @retval None
  */
__STATIC_INLINE void ll_iic_stop_det_interrupt_enable(IIC_TypeDef *p_iic) {
    p_iic->INTR_MASK |= LL_IIC_INTR_MASK_M_STOP_DET;
}

/**
  * @brief  IIC module disable stop condition detect interrupt
  * @param  p_iic: Select the initialized IIC group pointer
  * @retval None
  */
__STATIC_INLINE void ll_iic_stop_det_interrupt_disable(IIC_TypeDef *p_iic) {
    p_iic->INTR_MASK &= ~(LL_IIC_INTR_MASK_M_STOP_DET);
}

/**
  * @brief  IIC module enable start condition detect interrupt
  * @param  p_iic: Select the initialized IIC group pointer
  * @retval None
  */
__STATIC_INLINE void ll_iic_start_det_interrupt_enable(IIC_TypeDef *p_iic) {
    p_iic->INTR_MASK |= LL_IIC_INTR_MASK_M_START_DET;
}

/**
  * @brief  IIC module disable start condition detect interrupt
  * @param  p_iic: Select the initialized IIC group pointer
  * @retval None
  */
__STATIC_INLINE void ll_iic_start_det_interrupt_disable(IIC_TypeDef *p_iic) {
    p_iic->INTR_MASK &= ~(LL_IIC_INTR_MASK_M_START_DET);
}

/**
  * @brief  IIC module enable General Call address interrupt
  * @param  p_iic: Select the initialized IIC group pointer
  * @retval None
  */
__STATIC_INLINE void ll_iic_gen_call_interrupt_enable(IIC_TypeDef *p_iic) {
    p_iic->INTR_MASK |= LL_IIC_INTR_MASK_M_GEN_CALL;
}

/**
  * @brief  IIC module disable General Call address interrupt
  * @param  p_iic: Select the initialized IIC group pointer
  * @retval None
  */
__STATIC_INLINE void ll_iic_gen_call_interrupt_disable(IIC_TypeDef *p_iic) {
    p_iic->INTR_MASK &= ~(LL_IIC_INTR_MASK_M_GEN_CALL);
}

/**
  * @brief  IIC module enable RESTART condition interrupt
  * @param  p_iic: Select the initialized IIC group pointer
  * @retval None
  */
__STATIC_INLINE void ll_iic_restart_det_interrupt_enable(IIC_TypeDef *p_iic) {
    p_iic->INTR_MASK |= LL_IIC_INTR_MASK_M_RESTART_DET;
}

/**
  * @brief  IIC module disable RESTART condition interrupt
  * @param  p_iic: Select the initialized IIC group pointer
  * @retval None
  */
__STATIC_INLINE void ll_iic_restart_det_interrupt_disable(IIC_TypeDef *p_iic) {
    p_iic->INTR_MASK &= ~(LL_IIC_INTR_MASK_M_RESTART_DET);
}

/**
  * @brief  IIC module enable master on hold interrupt
  * @param  p_iic: Select the initialized IIC group pointer
  * @retval None
  */
__STATIC_INLINE void ll_iic_master_on_hold_interrupt_enable(IIC_TypeDef *p_iic) {
    p_iic->INTR_MASK |= LL_IIC_INTR_MASK_M_MST_ON_HOLD;
}

/**
  * @brief  IIC module disable master on hold interrupt
  * @param  p_iic: Select the initialized IIC group pointer
  * @retval None
  */
__STATIC_INLINE void ll_iic_master_on_hold_interrupt_disable(IIC_TypeDef *p_iic) {
    p_iic->INTR_MASK &= ~(LL_IIC_INTR_MASK_M_MST_ON_HOLD);
}

/**
  * @brief  IIC module enable SCL Line is stuck at low interrupt
  * @param  p_iic: Select the initialized IIC group pointer
  * @retval None
  */
__STATIC_INLINE void ll_iic_scl_stuck_at_low_interrupt_enable(IIC_TypeDef *p_iic) {
    p_iic->INTR_MASK |= LL_IIC_INTR_MASK_M_SCL_STUCK_AT_LOW;
}

/**
  * @brief  IIC module disable SCL Line is stuck at low interrupt
  * @param  p_iic: Select the initialized IIC group pointer
  * @retval None
  */
__STATIC_INLINE void ll_iic_scl_stuck_at_low_interrupt_disable(IIC_TypeDef *p_iic) {
    p_iic->INTR_MASK &= ~(LL_IIC_INTR_MASK_M_SCL_STUCK_AT_LOW);
}

/**
  * @brief  Set the target address of iic in host mode.
  * @param  p_iic      : Select the initialized IIC group pointer
  * @param  target_addr: The destination address value of iic.
  * @retval None
  */
__STATIC_INLINE void ll_iic_set_target_addr(IIC_TypeDef *p_iic, u16 target_addr) {
    p_iic->TAR &= ~(LL_IIC_TAR_IC_TAR(0x3FF));
    p_iic->TAR |= LL_IIC_TAR_IC_TAR(target_addr);
}
